...
if ( ! function_exists( 'buildpress_add_docs_page' ) ) {
	...
	function buildpress_docs_page_output() {
		...
		<div class="wrap">
			...
			<p>
				<strong><a href="http://piman.ir/demo/buildpress/documents" class="button button-primary " target="_blank"><?php _ex( 'Click here to see online documentation of the theme!', 'backend', 'buildpress_wp' ); ?></a></strong>
			</p>
		</div>
		<?php
	}

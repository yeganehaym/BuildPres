...
class BuildPress_Customizer_Base {
	...
	*/
	public function register () {
		...
		$this->wp_customize->add_setting( 'footer_left_txt', array( 'default' => 'طراحی شده توسط <a href="http://www.rtl-theme.com">راست چین</a>.' ) );
		$this->wp_customize->add_setting( 'footer_right_txt', array( 'default' => '&copy; 1393 <strong>راست‌چین</strong>. تمامی حقوق محفوظ است.' ) );

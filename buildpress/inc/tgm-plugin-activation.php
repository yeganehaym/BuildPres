...
function buildpress_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'             => get_template_directory() . '/bundled-plugins/custom-sidebars.zip',
			'required'           => true,
			'version'            => '2.1.0.1'
		),
		array(
		...
		array(
			...
			'source'             => get_template_directory() . '/bundled-plugins/portfolio-post-type.zip',
			'required'           => false,
		),
		array(
			'name'               => 'Essential Grid',
			...
			'required'           => false,
			'version'            => '2.0.9',
			'external_url'       => 'http://codecanyon.net/item/essential-grid-wordpress-plugin/7563340?ref=RtlTheme'
		),
		array(

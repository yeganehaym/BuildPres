		...
		public function widget( $args, $instance ) {
			...
			<div class="testimonial">
				...
				<?php if ( count( $testimonials ) > 2 ) : ?>
					<a class="testimonial__carousel  testimonial__carousel--left" href="#carousel-testimonials-<?php echo $args['widget_id'] ?>" data-slide="next"><i class="fa  fa-angle-left" aria-hidden="true"></i><span class="sr-only" role="button">Next</span></a>
					<a class="testimonial__carousel  testimonial__carousel--right" href="#carousel-testimonials-<?php echo $args['widget_id'] ?>" data-slide="prev"><i class="fa  fa-angle-right" aria-hidden="true"></i><span class="sr-only" role="button">Previous</span></a>
				<?php endif; ?>

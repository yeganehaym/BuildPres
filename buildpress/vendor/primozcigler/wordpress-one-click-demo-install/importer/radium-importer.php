...
class Radium_Theme_Importer {
	...
	public function add_admin() {
		...
		add_submenu_page('themes.php', "Import Demo Data", "درون‌ریزی اطلاعات نمونه", 'switch_themes', 'radium_demo_installer', array($this, 'demo_installer'));
	...
	public function demo_installer() {
		?>
			<div class="wrap">
				<h2><span class="dashicons dashicons-update" style="line-height: 29px;"></span> درون ریزی اطلاعات نمونه</h2>
				<div style="background-color: #F5FAFD; margin:10px 0;padding: 10px;color: #0C518F;border: 3px solid #CAE0F3; claer:both; width:90%; line-height:18px;">
					<p class="tie_message_hint">درون‌ریزی اطلاعات نمونه (نوشته ها, برگه ها, تصاویر, تنظیمات قالب و...) ساده ترین روش برای نصب قالب شماست. این کار به شما اجازه ویرایش اطلاعات را بجای ایجاد آنها از ابتدا میکند. وقتی شما درون ریزی را اجرا میکنید، اتفاقات زیر رخ خواهند داد:</p>

					<ul style="padding-left: 20px; list-style-position: inside; list-style-type: square;">
						<li>هیچ کدام از نوشته ها، برگه ها، تصاویر یا هر اطلاعات دیگری که از قبل وجود داشته باشد حذف یا تغییر نخواهند کرد.</li>
						<li>تنظیمات وردپرس تغییر نخواهند کرد.</li>
						<li>نوشته ها، برگه ها، تصاویر و برخی ابزارک ها و فهرست ها درون ریزی خواهند شد.</li>
						<li>تصاویر از سرور ما دانلود خواهند شد و صرفاً برای استفاده برای نمونه است.</li>
						<li>لطفاً فقط یک بار روی دکمه "درون‌ریزی" کلیک کرده و صبر کنید. ممکن است چند دقیقه طول بکشد</li>
					</ul>
				</div>

				<div style="background-color: #F5FAFD; margin:10px 0; padding: 10px; color: #0C518F; border: 3px solid #CAE0F3; claer:both; width:90%; line-height:18px;">
					<p class="tie_message_hint">قبل از شروع، مطمئن باشید که افزونه های ضروری نصب و فعال شده باشند.</p>
				</div>
				<form method="post" class="js-one-click-import-form">
					...
					<input name="reset" class="panel-save button-primary" type="submit" value="اجرای درون‌ریزی" />
				...
				<script>
					jQuery( function ( $ ) {
						$( '.js-one-click-import-form' ).on( 'submit', function () {
							$( this ).append( '<p style="font-width: bold; font-size: 1.5em;"><span class="spinner" style="display: inline-block; float: none;"></span> درون ریزی شروع شد، لطفاً صبور باشید!</p>' );
